const CACHE_NAME="hephzibah-cyber-lab-v6";
const CORE=["./","./index.html","./css/osint-tree.css","./js/tree-data.js","./js/tree-loader.js","./manifest.webmanifest","./robots.txt","./sitemap.xml"];
